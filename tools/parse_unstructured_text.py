...
async def parse_unstructured_text(unstructured_text: str, model_client, code_executor_instance) -> str:
    ...
    termination_condition = MaxMessageTermination(20) | TextMentionTermination("successfully produced the expected JSON output")
    ...
    try:
        async for message in team.run_stream(task=task_message):
            ...
            if hasattr(message, 'source') and hasattr(message, 'content'):
                ...
                if json_found and consecutive_no_code_messages >= 1:
