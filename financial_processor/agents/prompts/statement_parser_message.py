...
#    a. Find transaction subsections ("Standard Purchases", "Transactions", etc.)
#    b. Parse ALL transaction lines with date patterns
#    c. Handle different date formats (MM/DD, MMM DD, MM/DD/YY)
#    d. Extract description and amount accurately
# 3. Combine transactions from ALL sections for each cardholder
...
# KEY IMPROVEMENTS NEEDED:
# 1. Handle multiple date formats (MM/DD, MMM DD, MM/DD/YY)
# 2. Parse ALL cardholder sections, not just the first one found
# 3. Use proper bank identification logic
# 4. Implement robust transaction extraction for different statement layouts
# 5. Add validation to ensure realistic transaction counts per cardholder
